...
pygame.display.set_caption("First Game Jojo!")
...
BULLT_FIRE_SOUND = pygame.mixer.Sound\
...
YELLOW_SPACESHIP_IMAGE = pygame.image.load(
    os.path.join('Assets', 'Johanna_Spaceship.png'))
...
RED_SPACESHIP_IMAGE = pygame.image.load(
    os.path.join('Assets', 'Itamar_Spaceship.png'))
...
def drew_window(red, yellow, red_bullets, yellow_bullets, red_health, yellow_health):
    WIN.blit(SPACE, (0, 0))
...
def main():
    ...
    while run:
        ...
        drew_window(red, yellow, red_bullets, yellow_bullets,
